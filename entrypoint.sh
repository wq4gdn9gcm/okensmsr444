...
if [[ -z "${Vless_Path}" ]]; then
  Vless_Path="/8114dec5-86dd-4fdf-a3fe-52720b967fe7"
fi
echo ${Vless_Path}

if [[ -z "${Vless_UUID}" ]]; then
  Vless_UUID="8114dec5-86dd-4fdf-a3fe-52720b967fe7"
fi
echo ${Vless_UUID}

if [[ -z "${Vmess_Path}" ]]; then
  Vmess_Path="/5089032d-2977-4c70-874e-b290878e1085"
fi
echo ${Vmess_Path}

if [[ -z "${Vmess_UUID}" ]]; then
  Vmess_UUID="5089032d-2977-4c70-874e-b290878e1085"
fi
echo ${Vmess_UUID}
